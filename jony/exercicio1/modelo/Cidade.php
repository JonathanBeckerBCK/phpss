...
class Cidade {
   ...
   {
        $CE = "A cidade " . $this->getNome() . ", localizada no estado " . $this->getEstado()->getNome() . " - " . $this->getEstado()->getSigla() . ", possui " . $this->getQtdHabitantes() . " Habitantes e uma altitude de " . $this->getAltitude() . " metros\n";
        return $CE;
   }
